    ...
    for key in results_stats_dic.keys():
        ...
        if(key[:1]=='p'):
            ...
            if(key=="pct_correct_dogs"):
                perc_string = "% Correct Dogs"
            elif(key=="pct_correct_breed"):
                perc_string = "% Correct Breed"
            elif(key=="pct_correct_notdogs"):
                perc_string = "% Correct 'Not-a' Dog"
            elif(key=="pct_labels_matched"):
                perc_string = "% Labels Match"
            print("{:23}: {:3f}".format(perc_string, results_stats_dic[key]))
